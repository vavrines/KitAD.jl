...
begin
    ...
    f
    save("layer1tau_density_raw.pdf", f)
    ...
    axislegend(; position=:lt)
    f
    save("layer1tau_temperature_raw.pdf", f)
end
...
begin
    ...
    axislegend(; position=:lt)
    f
    save("layer5tau_density_raw.pdf", f)
    ...
    axislegend(; position=:lt)
    f
    save("layer5tau_temperature_raw.pdf", f)
end
...
begin
    ...
    axislegend(; position=:lt)
    f
    save("layer10tau_density_raw.pdf", f)
...
begin
    ...
    axislegend(; position=:lt)
    f
    save("layer1tau_density_tune.pdf", f)
    ...
    axislegend(; position=:lt)
    f
    save("layer1tau_temperature_tune.pdf", f)
end
...
begin
    ...
    axislegend(; position=:lt)
    f
    save("layer5tau_density_tune.pdf", f)
    ...
    axislegend(; position=:lt)
    f
    save("layer5tau_temperature_tune.pdf", f)
end
...
begin
    ...
    axislegend(; position=:lt)
    f
    save("layer10tau_density_tune.pdf", f)
    ...
    axislegend(; position=:lt)
    f
    save("layer10tau_temperature_tune.pdf", f)
end
